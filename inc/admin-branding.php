...
function _dg_admin_footer() {
  _e( '<span id="dg-info"><i class="_dgicon-d"></i> Theme developed by <a href="mailto:support@durkangroup.com">Paul Carbo</a> at the <a href="http://www.durkangroup.com" target="_blank">Durkan Group</a>.</span>', '_dg' );
}
